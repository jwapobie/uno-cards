...
var filter :Array[Event.Type] = [Event.Type.CARD_SELECTED, Event.Type.HAND_PLAYED, Event.Type.CARD_SCORED, Event.Type.SCORE_CREATED, Event.Type.SCORE_MULTI_CREATED]
